...
class admin_note_home
{
    ...
    public function table_builder($result, &$markup)
    {
        ...
        foreach($result as $note)
        {
            ...
            $markup = $markup."<tr><td>".$note['note_type']."</td><td>".$note['note']."</td><td>".$note['note_year']."</td><td>".$note['created_user']."</td><td>".$note['last_modified_user']."</td><td> <a href='/nfb_washington/admin/note/".$note['note_id']."' class='button-1' role='button'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<a href='/nfb_washington/admin/note_link' class='button-2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Link&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr>";
        }
         $markup= $markup. "</table>";
    }
}