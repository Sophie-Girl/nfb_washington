...
<tr><th class='table-header'>Committee Name</th><th class='table-header'>Propublica ID</th><th class='table-header'> Actions</th></tr>";
        ...
        foreach ($sql_result as $committee)
        {
            ...
            $markup = $markup."<tr><td>".$committee['committee_name']."</td><td>".$committee['propublica_id']."</td><td><a href='/nfb_washington/admin/committee/".$committee['committee_id']."' class='button-".$count."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><a href='/nfb_washington/admin/committees/maintenance' class='button-".$count."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Maintain&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><a href='/nfb_washington/admin/committees/issue' class='button-".$count."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Link&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td></tr>";
